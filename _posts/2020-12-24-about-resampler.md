---
layout: post
title: speex resampler  
tags: audio process
excerpt: audio  
---   

### 关于speex resampler模块的测试使用

1. speex resampler非常好用，使用时需要添加相关的预定义宏-DFLOATING_POINT -DOUTSIDE_SPEEX -DUSE_SSE 
如果在android等arm架构上编译，需要使用-DUSE_NEON   
